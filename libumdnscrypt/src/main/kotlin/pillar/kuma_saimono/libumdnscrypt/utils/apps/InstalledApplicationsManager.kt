...
import pillar.kuma_saimono.libumdnscrypt.utils.Utils.allowInteractAcrossUsersPermissionIfRequired
import pillar.kuma_saimono.libumdnscrypt.utils.Utils.getUidForName
...
import pillar.kuma_saimono.libumdnscrypt.utils.preferences.TortaeKeys.MULTI_USER_SUPPORT
import pillar.kuma_saimono.libumdnscrypt.utils.session.AppSessionStore
import pillar.kuma_saimono.libumdnscrypt.utils.session.SessionKeys.MULTIPLE_USERS_EXISTS
...
class InstalledApplicationsManager private constructor(
    ...
    private fun getKnownApplications(): ArrayList<ApplicationData> {
        ...
        if (showSpecialApps) {
            ...
            specialDataApps.add(
                ApplicationData(
                    uniffi.torta_core.tortaText("connectivity_check"),
