...
import pillar.kuma_saimono.libumdnscrypt.settings.dnscrypt_rules.local.ImportRulesManager.DnsRulesRegex.Companion.blackListHostRulesRegex
import pillar.kuma_saimono.libumdnscrypt.settings.dnscrypt_rules.local.ImportRulesManager.DnsRulesRegex.Companion.blacklistIPRulesRegex
import pillar.kuma_saimono.libumdnscrypt.settings.dnscrypt_rules.local.ImportRulesManager.DnsRulesRegex.Companion.cloakingRulesRegex
import pillar.kuma_saimono.libumdnscrypt.settings.dnscrypt_rules.local.ImportRulesManager.DnsRulesRegex.Companion.forwardingRulesRegex
import pillar.kuma_saimono.libumdnscrypt.settings.dnscrypt_rules.local.ImportRulesManager.DnsRulesRegex.Companion.hostFileRegex
import pillar.kuma_saimono.libumdnscrypt.settings.dnscrypt_rules.local.ImportRulesManager.DnsRulesRegex.Companion.whiteListHostRulesRegex
...
class ImportRulesManager(
    ...
    companion object {
        const val UPDATE_REMOTE_DNS_RULES_PROGRESS_ACTION =
            "pillar.kuma_saimono.libumdnscrypt.UPDATE_REMOTE_DNS_RULES_PROGRESS_ACTION"
        const val UPDATE_LOCAL_DNS_RULES_PROGRESS_ACTION =
            "pillar.kuma_saimono.libumdnscrypt.UPDATE_LOCAL_DNS_RULES_PROGRESS_ACTION"
        const val UPDATE_DNS_RULES_PROGRESS_DATA =
            "pillar.kuma_saimono.libumdnscrypt.UPDATE_DNS_RULES_PROGRESS_DATA"
        const val UPDATE_TOTAL_DNS_RULES_PROGRESS_ACTION =
            "pillar.kuma_saimono.libumdnscrypt.UPDATE_TOTAL_DNS_RULES_PROGRESS_ACTION"
        const val UPDATE_TOTAL_DNS_RULES_PROGRESS_DATA =
            "pillar.kuma_saimono.libumdnscrypt.UPDATE_TOTAL_DNS_RULES_PROGRESS_DATA"
    }
}
